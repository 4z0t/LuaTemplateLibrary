...
namespace LTL
{
    ...
    public:
        ...
        ContextRef(lua_State* l, int index) : m_state{ l }, m_ref{ l, index } {}
     ...
     * Уничтожение объекта должно быть выполнено вручную. Имеется класс-обертка для работы со ссылаемым объектом ContextRef.
     * @see ContextRef
     * @tparam RefAccess
     */
    template <typename RefAccess = RefGlobalAccess>
